...
PICS = (environ.get('PICS', 'https://telegra.ph/file/de709efff463ace84b278.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1430593323').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', 'animedualaudiozippercartoonist').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AnimeColony')
